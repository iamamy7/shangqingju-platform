...
let ReportCatalogService = class ReportCatalogService {
    products = [
    ...
    resolve(codes) {
        ...
        return unique.map((code) => {
            ...
            if (!product)
                throw new common_1.NotFoundException(`报告模块 ${code} 不存在`);
            return product;
        });
    }
    quote(codes) {
        ...
        return { products, subtotal, discountRate, discount, total: subtotal - discount, currency: "CNY" };
    }
};
exports.ReportCatalogService = ReportCatalogService;
exports.ReportCatalogService = ReportCatalogService = __decorate([
